    ...
    <footer className="bg-[#af8f6f] text-[#5A3A22]">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            />
            <p className="mb-6 text-[#5A3A22]/90">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.to}
                    className="text-[#5A3A22] hover:text-[#E6C79C] transition-colors duration-300 cursor-pointer"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-start gap-3 text-[#5A3A22] hover:text-[#E6C79C] transition-colors duration-300"
              >
              ...
              <a
                ...
                className="flex items-center gap-3 text-[#5A3A22] hover:text-[#E6C79C] transition-colors duration-300"
              >
                <Phone className="w-5 h-5 shrink-0" />
                <span>+91 9270109911</span>
              </a>

              <div className="flex items-start gap-3 text-[#5A3A22]/90">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  {teamContacts.map((contact) => (
                    <a
                      ...
                      className="text-[#5A3A22] hover:text-[#E6C79C] transition-colors duration-300"
                    >
      ...
      <div className="border-t border-[#5A3A22]/30">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[#5A3A22]/80 text-sm text-center md:text-left">
            © 2026 Global Imports Nagpur. All rights reserved.
          </p>
          <p className="text-[#5A3A22]/80 text-sm">
            IEC License: 27EMQPG9332F1ZP | 16+ Years of Excellence in Global Trade
          </p>
        </div>
      </div>
    </footer>
